...
static const u8 sTrainerGenders[] = {
    ...
    TRAINER_DOUBLE, // TRAINERCLASS_TWINS
    TRAINER_MALE,   // TRAINERCLASS_HIKER
    TRAINER_FEMALE, // TRAINERCLASS_BATTLE_GIRL
    TRAINER_MALE,   // TRAINERCLASS_FISHERMAN
    TRAINER_DOUBLE, // TRAINERCLASS_BATTLE_KIN
    TRAINER_FEMALE, // TRAINERCLASS_PAINTER
    ...
    TRAINER_MALE,   // TRAINERCLASS_TAMER
    ...
    TRAINER_MALE,   // TRAINERCLASS_ROCKER
    ...
    TRAINER_MALE,   // TRAINERCLASS_CUE_BALL
    TRAINER_MALE,   // TRAINERCLASS_CLOWN
    TRAINER_MALE,   // TRAINERCLASS_ENGINEER
    ...
    TRAINER_MALE,   // TRAINERCLASS_LEADER_KOGA
    TRAINER_FEMALE, // TRAINERCLASS_LEADER_SABRINA
    TRAINER_MALE,   // TRAINERCLASS_LEADER_BLAINE
    TRAINER_MALE,   // TRAINERCLASS_LEADER_GIOVANNI
    TRAINER_DOUBLE, // TRAINERCLASS_SIS_AND_BRO
    TRAINER_MALE,   // TRAINERCLASS_SUPER_NERD
    TRAINER_MALE,   // TRAINERCLASS_GAMBLER
    ...
    TRAINER_FEMALE, // TRAINERCLASS_ELITE_FOUR_LORELEI
    TRAINER_MALE,   // TRAINERCLASS_ELITE_FOUR_LANCE
    TRAINER_MALE,   // TRAINERCLASS_ELITE_FOUR_BRUNO
    ...
    TRAINER_MALE,   // TRAINERCLASS_LEADER_09
    ...
    TRAINER_FEMALE, // TRAINERCLASS_PKMN_TRAINER_RED
    TRAINER_MALE,   // TRAINERCLASS_PKMN_TRAINER_GREEN
    TRAINER_MALE,   // TRAINERCLASS_TEAM_ROCKET_JAMES
    TRAINER_FEMALE, // TRAINERCLASS_TEAM_ROCKET_JESSIE
    TRAINER_FEMALE, // TRAINERCLASS_LEADER_14
    TRAINER_MALE,   // TRAINERCLASS_LEADER_15
    TRAINER_MALE,   // TRAINERCLASS_PKMN_TRAINER_ASH
    TRAINER_FEMALE, // TRAINERCLASS_PKMN_TRAINER_YELLOW
    TRAINER_MALE,   // TRAINERCLASS_ELDER
    TRAINER_DOUBLE, // TRAINERCLASS_ELITE_FOUR_AGATHA
    ...
    TRAINER_MALE,   // TRAINERCLASS_EXECUTIVE_ORION
    TRAINER_MALE,   // TRAINERCLASS_EXECUTIVE_CONSTANTIN
    TRAINER_MALE,   // TRAINERCLASS_PASSERBY
    TRAINER_MALE,   // TRAINERCLASS_MYSTERY_MAN
    TRAINER_DOUBLE, // TRAINERCLASS_ACE_DUO
    TRAINER_DOUBLE, // TRAINERCLASS_YOUNG_COUPLE
